...
Route::post('/user/delete/{id}','ProfileController@konfirmasi_delete');
Route::get('/user/{id}/profile', 'ProfileController@profile');
Route::get('/user/{id}/people','ProfileController@people_form');
Route::post('/user/update/email','EmailController@update_email');
Route::post('/user/update/password','EmailController@update_password');
